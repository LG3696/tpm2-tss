...
SIM_TMP_DIR=$(mktemp --directory --tmpdir=/tmp swtpm_XXXXXX)
PORT_MIN=1024
PORT_MAX=65534
BACKOFF_FACTOR=2
BACKOFF_MAX=6
...
for i in $(seq ${BACKOFF_MAX}); do
    ...
    simulator_start swtpm ${SIM_PORT_DATA} ${SIM_LOG_FILE} ${SIM_PID_FILE} ${SIM_TMP_DIR}
